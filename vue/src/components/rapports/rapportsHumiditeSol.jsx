...
function RapportsHumiditeSol() {
    ...
    const handleGenerer = () => {
        ...
        generer_rapport_capteur("humidite-sol", format, dateDebut, dateFin, etatsSelectionnes, setChargement, setErreur);
    };
        ...
        <div className="rapport-root">
            <div className="rapport-shell">
                <header className="rapport-header">
                    ...
                    <h1 className="rapport-titre">Rapport Humidité du sol</h1>
                    <p className="rapport-sous-titre">Humidité du sol — capteur YL-69 (GPIO 36)</p>
                </header>
                    ...
                    <div className="rapport-controls">
                        <div className="rapport-controls-row">
                            <div className="rapport-periode">
                                <label className="rapport-label" htmlFor="hum-debut">
                                    Du
                                    <input id="hum-debut" type="date" value={dateDebut} max={dateFin} onChange={(e) => setDateDebut(e.target.value)} className="rapport-input-date" />
                                </label>
                                <label className="rapport-label" htmlFor="hum-fin">
                                    Au
                                    <input id="hum-fin" type="date" value={dateFin} min={dateDebut} max={AUJOURD_HUI} onChange={(e) => setDateFin(e.target.value)} className="rapport-input-date" />
                                </label>
                            </div>
                            ...
                            <fieldset className="rapport-format">
                                ...
                                <label className="rapport-radio"><input type="radio" name="fmt-hum" value="csv" checked={format === "csv"} onChange={() => setFormat("csv")} />CSV</label>
                                <label className="rapport-radio"><input type="radio" name="fmt-hum" value="pdf" checked={format === "pdf"} onChange={() => setFormat("pdf")} />PDF</label>
                            </fieldset>
                        </div>
...
export default RapportsHumiditeSol;
