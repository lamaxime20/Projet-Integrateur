...
function RapportsTemperature() {
    ...
    const handleGenerer = () => {
        ...
        generer_rapport_capteur("temperature", format, dateDebut, dateFin, etatsSelectionnes, setChargement, setErreur);
    };
    ...
    return (
        <div className="rapport-root">
            <div className="rapport-shell">
                    ...
                    <div className="rapport-controls">
                        <div className="rapport-controls-row">
                            <div className="rapport-periode">
                                <label className="rapport-label" htmlFor="temp-debut">
                                    Du
                                    <input id="temp-debut" type="date" value={dateDebut} max={dateFin} onChange={(e) => setDateDebut(e.target.value)} className="rapport-input-date" />
                                </label>
                                <label className="rapport-label" htmlFor="temp-fin">
                                    Au
                                    <input id="temp-fin" type="date" value={dateFin} min={dateDebut} max={AUJOURD_HUI} onChange={(e) => setDateFin(e.target.value)} className="rapport-input-date" />
                                </label>
                            </div>
                            ...
                            <fieldset className="rapport-format">
                                ...
                                <label className="rapport-radio"><input type="radio" name="fmt-temp" value="csv" checked={format === "csv"} onChange={() => setFormat("csv")} />CSV</label>
                                <label className="rapport-radio"><input type="radio" name="fmt-temp" value="pdf" checked={format === "pdf"} onChange={() => setFormat("pdf")} />PDF</label>
                            </fieldset>
                        </div>
                ...
                <RapportCourbeCapteur capteur="temperature" titre="Température de l'air" unite="°C" />
...
export default RapportsTemperature;
