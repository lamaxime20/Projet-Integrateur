...
function RapportsAmpoule() {
    ...
    const handleGenererInstructions = () => {
        generer_rapport_instructions("ampoule", formatInstr, dateDebutInstr, dateFinInstr, setChargementInstr, setErreurInstr);
    };
            ...
            <div className="rapport-shell">
                ...
                <section className="rapport-section">
                    ...
                    <div className="rapport-controls">
                        <div className="rapport-controls-row">
                            <div className="rapport-periode">
                                <label className="rapport-label" htmlFor="ampoule-debut">Du <input id="ampoule-debut" type="date" value={dateDebutGraph} max={dateFinGraph} onChange={(e) => setDateDebutGraph(e.target.value)} className="rapport-input-date" /></label>
                                <label className="rapport-label" htmlFor="ampoule-fin">Au <input id="ampoule-fin" type="date" value={dateFinGraph} min={dateDebutGraph} max={AUJOURD_HUI} onChange={(e) => setDateFinGraph(e.target.value)} className="rapport-input-date" /></label>
                            </div>
                            <fieldset className="rapport-etats">
                                <legend className="rapport-etats-legend">États à afficher</legend>
                                <label className="rapport-checkbox"><input type="checkbox" checked={etatsGraph.running} onChange={() => handleToggleEtat("running")} /><span className="rapport-dot vert" aria-hidden="true"></span>Allumée</label>
                                <label className="rapport-checkbox"><input type="checkbox" checked={etatsGraph.stopped} onChange={() => handleToggleEtat("stopped")} /><span className="rapport-dot orange" aria-hidden="true"></span>Éteinte</label>
                            ...
                            <fieldset className="rapport-format">
                                ...
                                <label className="rapport-radio"><input type="radio" name="fmt-ampoule" value="csv" checked={formatGraph === "csv"} onChange={() => setFormatGraph("csv")} />CSV</label>
                                <label className="rapport-radio"><input type="radio" name="fmt-ampoule" value="pdf" checked={formatGraph === "pdf"} onChange={() => setFormatGraph("pdf")} />PDF</label>
                            </fieldset>
                        </div>
                    ...
                    <div className="rapport-graph-wrapper">
                        <GrapheBatonnet historique={historiqueFiltré} vocabulaire={{ running: "Allumée", stopped: "Éteinte", defaillant: "Défaillante" }} />
                    </div>
                    <div className="rapport-legende">
                        <div className="rapport-legende-item"><span className="rapport-dot vert" aria-hidden="true"></span>Allumée</div>
                        <div className="rapport-legende-item"><span className="rapport-dot orange" aria-hidden="true"></span>Éteinte</div>
                    ...
                    {grandeurs.luminosite !== undefined && (
                        <div className="rapport-grandeurs">
                            <div className="rapport-grandeur-item">
                                <div className="rapport-grandeur-cercle">{grandeurs.luminosite}<span className="rapport-grandeur-unite">%</span></div>
                                <span className="rapport-grandeur-label">Luminosité</span>
                            </div>
                        </div>
                    )}
                </section>
                ...
                <section className="rapport-section">
                    <div className="rapport-section-heading"><h2>Historique des instructions</h2><p>Liste des commandes envoyées à l'ampoule.</p></div>

                    <div className="rapport-instructions-filtres">
                        <div className="rapport-filtres-row">
                            <div className="rapport-periode">
                                <label className="rapport-label" htmlFor="instr-ampoule-debut">Du <input id="instr-ampoule-debut" type="date" value={dateDebutInstr} max={dateFinInstr} onChange={(e) => setDateDebutInstr(e.target.value)} className="rapport-input-date" /></label>
                                <label className="rapport-label" htmlFor="instr-ampoule-fin">Au <input id="instr-ampoule-fin" type="date" value={dateFinInstr} min={dateDebutInstr} max={AUJOURD_HUI} onChange={(e) => setDateFinInstr(e.target.value)} className="rapport-input-date" /></label>
                            </div>
                            ...
                            <tbody>
                                {instructionsFiltrees.length === 0 ? (
                                    ...
                                    <tr key={instr.id}>
                                        ...
                                        <td>{instr.action === "allumer" ? "Allumer" : "Éteindre"}</td>
                    ...
                    <div className="rapport-section-actions">
                        <fieldset className="rapport-format">
                            <legend className="rapport-etats-legend">Format</legend>
                            <label className="rapport-radio"><input type="radio" name="fmt-instr-ampoule" value="csv" checked={formatInstr === "csv"} onChange={() => setFormatInstr("csv")} />CSV</label>
                            <label className="rapport-radio"><input type="radio" name="fmt-instr-ampoule" value="pdf" checked={formatInstr === "pdf"} onChange={() => setFormatInstr("pdf")} />PDF</label>
                        </fieldset>
...
export default RapportsAmpoule;
