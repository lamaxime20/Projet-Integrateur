...
import { charger_etat_ventilateur, charger_temperature_actuelle } from "../../../utils/actionneur";
            ...
            <div className="ventilateurDetails-content">
                ...
                <section className="ventilateurDetails-other">
                    ...
                    <div className="ventilateurDetails-temperature">
                        <a 
                            className={`ventilateurDetails-item-temperature
                                ${temperature < seuils["temperature_min"] && "temperature-vert"}
                                ${temperature > seuils["temperature_max"] && "temperature-rouge"}
                                ${temperature < seuils["temperature_min"] && temperature > seuils["temperature_max"] && "temperature-orange"}
                            `}
                        >
                            {temperature}°C
                        </a>
